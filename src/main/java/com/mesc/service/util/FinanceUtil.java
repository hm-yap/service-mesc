...
/**
 * Finance utility class to handle financial operations, such as tax calculations, round adjustment. 
 * @author Hao Meng Yap
 *
 */
public class FinanceUtil {	
	 ...
	 * @param preTaxAmt Amount before tax
	 * @param taxPct Tax percentage
	 * @return Taxed amount
	 */
	 ...
	 * 0.17 ---> 0.15<br>
	 * 0.18 ---> 0.20
	 * @param notRoundAmt Amount before rounded
	 * @return Amount rounded to the nearest 5 cents
	 */
	public static BigDecimal getRoundedAmt(BigDecimal notRoundAmt) {
		BigDecimal divided = notRoundAmt.divide(increment, 0, BigDecimal.ROUND_HALF_UP);
	 ...
	 * @param subTotals A list of sub totals in BigDecimal
